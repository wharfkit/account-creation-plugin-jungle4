> [!IMPORTANT]
> This package lives in the WharfKit monorepo at [wharfkit/js/packages/account-creation-plugin-jungle4](https://github.com/wharfkit/js/tree/dev/packages/account-creation-plugin-jungle4), and this repository is archived. Open new issues and pull requests on [wharfkit/js](https://github.com/wharfkit/js).
